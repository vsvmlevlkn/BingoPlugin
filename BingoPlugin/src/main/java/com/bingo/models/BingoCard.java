...
/**
 * Represents a 5x5 Bingo card for a team.
 * Tracks item completion state and checks win conditions.
 */
public class BingoCard {
    ...
    /**
     * Marks an item at position (row, col) as completed.
    ...
    public BingoItem getItem(int row, int col) {
    ...
    /**
     * Checks if the card has any winning line (row, col, or diagonal).
     */
    ...
    /**
     * Updates card completion state based on what items the team currently has.
     * Called from InventoryListener.
     *
     * @param teamInventory Set of materials currently held by any team member
